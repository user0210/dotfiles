...
O.user_plugins = {
	{"christoomey/vim-tmux-navigator",
	  config = function()
			...
			vim.cmd "nnoremap <silent> <c-ä> :TmuxNavigatePrevious<cr>"
		end
	},
...
-- center the cursor
vim.cmd('set so=999')
-- hide bufferline when there is only one
