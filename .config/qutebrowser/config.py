from base16colors import *
from pywalcolors import *
...
c.colors.completion.item.selected.bg = color11
c.colors.completion.item.selected.border.top = color3
c.colors.completion.item.selected.border.bottom = color3
c.colors.completion.item.selected.match.fg = color9
...
c.colors.contextmenu.selected.bg = color11
c.colors.contextmenu.selected.fg = color0
c.colors.downloads.bar.bg = color0
c.colors.downloads.start.fg = color0
c.colors.downloads.start.bg = color12
c.colors.downloads.stop.fg = color0
c.colors.downloads.stop.bg = color14
c.colors.downloads.error.fg = color9
...
c.colors.messages.error.bg = color9
c.colors.messages.error.border = color9
c.colors.messages.warning.fg = color0
c.colors.messages.warning.bg = color13
c.colors.messages.warning.border = color13
...
c.colors.statusbar.caret.selection.bg = color12
c.colors.statusbar.progress.bg = color12
...
c.colors.tabs.pinned.selected.even.bg = color14
c.colors.tabs.pinned.selected.even.fg = color0
c.colors.tabs.pinned.selected.odd.bg = color14
